            ...
            <div class="col">
                <div class="card h-100 w-100">
                    <div class="card-body">
                        ...
                        <p class="card-text"><strong>Content :</strong> {!! strip_tags(Str::substr($result->content, 0,
                            50 )) !!}</p>
                    </div>
                    {{-- This can be used to view , edit and delete redirection --}}
                    <div class="btn-wraper">
                        <a href="{{url('/blog/view/'. $result->id)}}" class="btn btn-success">View</a>
                        <a href="{{url('blog/edit/'. $result->id)}}" class="btn btn-primary">Edit</a>
                        <a href="{{url('/blog/delete/' . $result->id)}} " class="btn btn-danger">Delete</a>
                    </div>
                </div>
            </div>
            @endforeach
